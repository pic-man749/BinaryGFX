...
#ifndef USERLIB_BINARYGFX_CORE_INC_OBJECTS_IGRAPHICSOBJECT_HPP_
#define USERLIB_BINARYGFX_CORE_INC_OBJECTS_IGRAPHICSOBJECT_HPP_
...
#endif /* USERLIB_BINARYGFX_CORE_INC_OBJECTS_IGRAPHICSOBJECT_HPP_ */
